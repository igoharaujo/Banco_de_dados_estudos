...
VALUES
    ...
    ('Temporada 3', 'Terceira temporada da série Breaking Bad', 1),
    ('Temporada 4', 'Quarta temporada da série Breaking Bad', 1),
    ('Temporada 5', 'Quinta e última temporada da série Breaking Bad', 1),
    ('Temporada 1', 'Primeira temporada da série Friends', 2),
    ('Temporada 2', 'Segunda temporada da série Friends', 2),
    ('Temporada 3', 'Terceira temporada da série Friends', 2),
    ('Temporada 4', 'Quarta temporada da série Friends', 2),
    ('Temporada 5', 'Quinta temporada da série Friends', 2),
    ('Temporada 1', 'Primeira temporada da série Game of Thrones', 3),
    ('Temporada 2', 'Segunda temporada da série Game of Thrones', 3),
    ('Temporada 3', 'Terceira temporada da série Game of Thrones', 3),
    ('Temporada 4', 'Quarta temporada da série Game of Thrones', 3),
    ('Temporada 5', 'Quinta temporada da série Game of Thrones', 3),
    ('Temporada 1', 'Primeira temporada da série Stranger Things', 4),
    ('Temporada 2', 'Segunda temporada da série Stranger Things', 4),
    ('Temporada 3', 'Terceira temporada da série Stranger Things', 4),
    ('Temporada 1', 'Primeira temporada da série The Crown', 5),
    ('Temporada 2', 'Segunda temporada da série The Crown', 5);
...
VALUES
    ...
    (3, 6, 1),   -- Episódio 3 da série Breaking Bad, Temporada 1
    -- Insira os demais episódios da série Breaking Bad aqui
    (1, 7, 6),   -- Episódio 1 da série Friends, Temporada 6
    (2, 7, 6),   -- Episódio 2 da série Friends, Temporada 6
    (3, 7, 6),   -- Episódio 3 da série Friends, Temporada 6
    -- Insira os demais episódios da série Friends aqui
    (1, 8, 11),  -- Episódio 1 da série Game of Thrones, Temporada 11
    (2, 8, 11),  -- Episódio 2 da série Game of Thrones, Temporada 11
    (3, 8, 11),  -- Episódio 3 da série Game of Thrones, Temporada 11
    -- Insira os demais episódios da série Game of Thrones aqui
    (1, 9, 16),  -- Episódio 1 da série Stranger Things, Temporada 16
    (2, 9, 16),  -- Episódio 2 da série Stranger Things, Temporada 16
    (3, 9, 16),  -- Episódio 3 da série Stranger Things, Temporada 16
    -- Insira os demais episódios da série Stranger Things aqui
    (1, 10, 19), -- Episódio 1 da série The Crown, Temporada 19
    (2, 10, 19); -- Episódio 2 da série The Crown, Temporada 19
